...
void plot_TruthAnalysis_SBStudy_Hist(TH1F *h_excl, TH1F *h_incl,TH1F *h_excl_cutflow, TH1F *h_incl_cutflow, TH1F *h_Ztautau, TH1F *h_Ztautau_cutflow, TH1F *h_DYmumu, TH1F *h_DYmumu_cutflow, TH1F *h_Zmumu, TH1F *h_Zmumu_cutflow );


// Plot pT(e-mu) for single configuration
void plot_CumulativeTruthStudy(std::string p_f_exclWW, std::string p_f_inclWW, std::string p_f_Ztautau, std::string p_f_DYmumu, std::string p_f_Zmumu) // For simplicity keeping p_f_inclWW as the name, so I don't have to rename everything. Let Zmumu be inclWW.
{
  ...
  plot_TruthAnalysis_SBStudy_Hist(h_excl, h_incl, h_excl_cutflow, h_incl_cutflow, h_Ztautau, h_Ztautau_cutflow, h_DYmumu, h_DYmumu_cutflow, h_Zmumu, h_Zmumu_cutflow );
