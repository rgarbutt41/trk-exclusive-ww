...
OUTDIR="/global/projecta/projectdirs/atlas/wmccorma/TrkExclusiveWW/trk-exclusive-ww-athena/run/Mar19_arraytest_1"
SUBDIR="arraytest_runfolder"
...
--inputRDOFile $SAMPLE \
--outputAODFile AOD.${SLURM_ARRAY_TASK_ID}.pool.root \
--maxEvents 20 
